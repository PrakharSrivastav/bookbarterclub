...
<div class="margin-none white margin-top-10 row padding-10" style="min-height:550px">
    <div class="col s12 white m2 padding-5">
        <div class="col s12 white margin-none padding-none"  style="min-height:540px">
            <div class="collection white margin-none">
                @if(isset($all_data))
                @foreach($all_data as $sender=>
                $val)
                <a href="#!" id="{{str_replace(' ','_',$sender)}}" data-user="{{$val[0]['sender_id']}}" class="collection-item red darken-2 grey-text text-lighten-3 name">
                    {{$sender}}
                </a>
                @endforeach
                @endif
                ...
                <form class="grey lighten-3 padding-5">
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <span class="red-text" id="message_error">
                            </span>
                        </div>
                    ...
                    <div class="margin-left-10">
                        <button type="button" id="send_message" class="red darken-2 text-grey text-lighten-3 btn">
                            Reply
                        </button>
                    </div>
                </form>

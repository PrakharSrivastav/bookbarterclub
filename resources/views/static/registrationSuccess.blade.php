...
<div class="row margin-none">
    ...
    <div class="col s12 margin-none margin-top-15 padding-20 center-align">
        <h4 class="margin-top-10 padding-top-20 light">Your Account has been successfully activated</h4>
        <p class="center-align light margin-top-20 padding-top-20">Please click on the below button to login</p>

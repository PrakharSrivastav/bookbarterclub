    ...
    <div class="row ">
        <div class="margin-top-100">
            <div class="col m6 offset-m3 s12">
                <form id="login_form" class="card z-depth-3 padding-15 yellow darken-2" role="form" method="POST" action="{{ url('/login') }}">
                    {!! csrf_field() !!}
                    <h6>Login</h6>
                    <div class="row">
                        <div class="input-field col s12">
                            <input type="email"  name="email" value="{{ old('email') }}" id="email" class="validate black-text" required="">
                            <label for="disabled">E-Mail Address</label>
                            @if ($errors->has('email'))
                    ...
                    <p>
                    <input type="submit" id="submit_login_form" class="btn waves-effect waves-light white black-text" value="Login">
